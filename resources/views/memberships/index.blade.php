...
<div class="row">
  <div class="col-12">
    <div class="page-header">
      <h3 class="page-title">Customers → Membership</h3>
    </div>
  </div>
</div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
          ...
          <div class="d-flex">
            <form action="{{ route('memberships.index') }}" method="GET" class="d-flex mr-2">
              ...
              @if(request('search'))
                <a href="{{ route('memberships.index') }}" class="btn btn-sm btn-secondary mr-2">
                  <i class="mdi mdi-close"></i> Clear
                </a>
              @endif
            </form>
            <button class="btn btn-sm btn-primary" onclick="window.location.href='{{ route('memberships.create') }}'">
