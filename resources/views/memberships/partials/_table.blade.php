                ...
                <div class="dropdown-menu dropdown-menu-right filter-accordion" aria-labelledby="filterDropdown">
                  ...
                  <div class="filter-section">
                    ...
                    <div class="filter-section-content">
                      <a class="filter-option filter-option-active" href="javascript:void(0)" onclick="MembershipsPage.applyFilter('status', 'active')">
                        <i class="mdi mdi-check-circle"></i> Active
                      </a>
                      <a class="filter-option filter-option-expired" href="javascript:void(0)" onclick="MembershipsPage.applyFilter('status', 'expired')">
                        <i class="mdi mdi-close-circle"></i> Expired
                      </a>
                      <a class="filter-option filter-option-due-soon" href="javascript:void(0)" onclick="MembershipsPage.applyFilter('status', 'due_soon')">
                  ...
                  <div class="filter-section">
                    ...
                    <div class="filter-section-content">
                      <a class="filter-option filter-option-male" href="javascript:void(0)" onclick="MembershipsPage.applyFilter('gender', 'Male')">
                        <i class="mdi mdi-human-male"></i> Male
                      </a>
                      <a class="filter-option filter-option-female" href="javascript:void(0)" onclick="MembershipsPage.applyFilter('gender', 'Female')">
