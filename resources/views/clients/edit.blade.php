...
<div class="content-wrapper" style="background: linear-gradient(135deg, #1e3a5f 0%, #2c5282 100%); min-height: 100vh;">
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <h3 class="text-white mb-2" style="font-weight: 500;">Edit Client</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background: transparent;">
                        <li class="breadcrumb-item"><a href="{{ route('clients.index') }}" class="text-white-50">Clients</a></li>
                        <li class="breadcrumb-item active text-white" aria-current="page">Edit Client</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('clients.update', $client) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                @if($client->avatar)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $client->avatar) }}" alt="{{ $client->name }}" id="avatarPreview" style="width: 120px; height: 120px; object-fit: cover; border-radius: 10px; border: 3px solid rgba(255, 255, 255, 0.2);">
                                    </div>
                                @else
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <select name="plan_type" class="form-control @error('plan_type') is-invalid @enderror"
                                            ...
                                            <option value="Monthly" {{ old('plan_type', $client->plan_type) == 'Monthly' ? 'selected' : '' }}>Monthly</option>
                                            <option value="Session" {{ old('plan_type', $client->plan_type) == 'Session' ? 'selected' : '' }}>Session</option>
                                        </select>
                                        @error('plan_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="d-flex gap-2 justify-content-end mt-4">
                                ...
                                <button type="submit" class="btn btn-warning" style="background: #FFA500; border: none; padding: 10px 24px; border-radius: 8px; color: white;">
                                    <i class="mdi mdi-pencil"></i> Update Client
                                </button>
                            </div>
                        </form>
                    </div>
