...
@section('title', 'Training Sessions - AbsTrack Fitness Gym')
...
@section('content')
    ...
    <div class="card page-header-card">
        <div class="card-body">
            <div>
                <h2 class="page-header-title">Training Sessions</h2>
                <p class="page-header-subtitle">Manage personal training schedules and bookings.</p>
            </div>
    ...
    @include('Sessions.partials._pt-stats')
...
@push('scripts')
    @include('Sessions.partials._pt-scripts')
@endpush
